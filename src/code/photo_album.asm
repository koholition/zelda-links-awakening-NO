...
IF LANG_NO
    db   $8B, $8C, $8D, $24, $24, $24, $24, $24 ; $6911 |...$$$%$|
ELSE
...
IF LANG_NO
    db   $0F, $2D, $2E, $2F, $24, $0B, $0C, $15 ; $6929 |.-./$..$|
ELSE
...
IF LANG_NO
    db   $24, $1B, $1C, $25, $26, $27, $24, $24 ; $6941 |$..$&'$$|
ELSE
    db   $24, $1B, $1C, $24, $26, $27, $24, $24 ; $6941 |$..$&'$$|
ENDC
    db   $24, $38, $39, $3A, $AB, $AC, $AD, $4E ; $6949 |$89:...N|
IF LANG_NO
    db   $4F, $6D, $6E, $6F, $24, $2B, $2C, $35 ; $6951 |Omno$+,$|
ELSE
...
IF LANG_NO
    db   $24, $3B, $3C, $45, $46, $47, $24, $24 ; $6969 |$                                                                                                                                        ;<$FG$$|
ELSE
